...
export default function App() {
  ...
  return (
    <div id="top">
      ...
      <main>
          ...
          <section id="configure" ref={configureRef} className="configurator-section">
            <div className="shell">
              ...
              {orderMode === 'guided' && selectedJourney ? (
                <GuidedOrder key={`${selectedProduct.id}-${selectedJourney.id}-${JSON.stringify(preset)}`} product={selectedProduct} journey={selectedJourney} preset={preset} task={taskContext} onAdvanced={() => setOrderMode('advanced')}/>
              ) : (
        ...
        <section id="quick-points" className="shell section quick-point-section">
          ...
          <div className="location-card">
            ...
            <div className="location-row"><div><strong>Quick Solution Café</strong><span>Full service location</span></div><span>Open</span></div>
            <div className="location-row"><div><strong>Partner Quick Point</strong><span>Print + apparel collection</span></div><span>850m</span></div>
          </div>
        </section>
      ...
      <footer className="shell footer"><strong>Joint X Quick Solution Café</strong><span>Location 001 · Built on XOS · <a href="#admin">Product Admin</a></span></footer>
    </div>
  )
}
